...
gp1 = love.audio.newSource("sounds/green.mp3", "static")
gp1:setVolume(SFXV-.7-adj)
gp2 = love.audio.newSource("sounds/green.mp3", "static")
gp2:setVolume(SFXV-.7-adj)
