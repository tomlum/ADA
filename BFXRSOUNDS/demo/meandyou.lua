...
mbb,mgg,mpp,ybb,ygg,ypp = 0,0,0,0,0,0
...
controller2 = {}
	...
	enviro.ptile = love.graphics.newImage("enviro/ptile.png")
	enviro.ptile:setFilter("nearest")
	enviro.btile = love.graphics.newImage("enviro/btile.png")
	enviro.btile:setFilter("nearest")
	enviro.gtile = love.graphics.newImage("enviro/gtile.png")
	enviro.gtile:setFilter("nearest")
	enviro.ytile = love.graphics.newImage("enviro/ytile.png")
	...
	enviro.partitionwall = love.graphics.newImage("enviro/partition.png")
