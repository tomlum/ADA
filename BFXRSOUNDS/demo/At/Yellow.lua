...
for i,v in ipairs(yourmines) do
	...
	table.insert(you.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 0, s = 0, v = boltspeed * 1})
		...
		table.insert(you.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 6, s = 0, v = boltspeed * .96})
		table.insert(you.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -6, s = 0, v = boltspeed * .96})
		table.insert(you.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -12, s = 0, v = boltspeed * .93})
		table.insert(you.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 12, s = 0, v = boltspeed * .93})
		table.insert(you.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -18, s = 0, v = boltspeed * .9})
		table.insert(you.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 18, s = 0, v = boltspeed * .9})
		table.insert(you.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -24, s = 0, v = boltspeed * .9})
		table.insert(you.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 24, s = 0, v = boltspeed * .9})
		table.insert(you.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -30, s = 0, v = boltspeed * .9})
		table.insert(you.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 30, s = 0, v = boltspeed * .9})
		table.insert(you.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -36, s = 0, v = boltspeed * .9})
		table.insert(you.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 36, s = 0, v = boltspeed * .9})
		table.insert(you.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -42, s = 0, v = boltspeed * .9})
		table.insert(you.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 42, s = 0, v = boltspeed * .9})
		table.insert(you.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -48, s = 0, v = boltspeed * .9})
		table.insert(you.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 48, s = 0, v = boltspeed * .9})
		table.insert(you.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -54, s = 0, v = boltspeed * .9})
		table.insert(you.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 54, s = 0, v = boltspeed * .9})
...
if v.s == 1 or v.s == 0 or v.s == -1 then
	...
	if v.s == 100 then 
		...
		table.insert(me.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 6, s = 0, v = boltspeed * .96})
		table.insert(me.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -6, s = 0, v = boltspeed * .96})
		table.insert(me.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -12, s = 0, v = boltspeed * .93})
		table.insert(me.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 12, s = 0, v = boltspeed * .93})
		table.insert(me.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -18, s = 0, v = boltspeed * .9})
		table.insert(me.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 18, s = 0, v = boltspeed * .9})
		table.insert(me.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -24, s = 0, v = boltspeed * .9})
		table.insert(me.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 24, s = 0, v = boltspeed * .9})
		table.insert(me.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -30, s = 0, v = boltspeed * .9})
		table.insert(me.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 30, s = 0, v = boltspeed * .9})
		table.insert(me.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -36, s = 0, v = boltspeed * .9})
		table.insert(me.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 36, s = 0, v = boltspeed * .9})
		table.insert(me.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -42, s = 0, v = boltspeed * .9})
		table.insert(me.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 42, s = 0, v = boltspeed * .9})
		table.insert(me.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -48, s = 0, v = boltspeed * .9})
		table.insert(me.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 48, s = 0, v = boltspeed * .9})
		table.insert(me.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -54, s = 0, v = boltspeed * .9})
		table.insert(me.bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 54, s = 0, v = boltspeed * .9})
