...
aby22 = love.graphics.newImage("me/attack/ay22.png")
aby23 = love.graphics.newImage("me/attack/ay23.png")
aby24 = love.graphics.newImage("me/attack/ay24.png")
aby2 = love.graphics.newImage("me/attack/ay2.png")
aby3 = love.graphics.newImage("me/attack/ay3.png")
aby4 = love.graphics.newImage("me/attack/ay4.png")
abyend = love.graphics.newImage("me/attack/ayend.png")
aby2end = love.graphics.newImage("me/attack/ay2end.png")
jyready = love.graphics.newImage("me/attack/jyready.png")
jpyready = love.graphics.newImage("me/attack/jpyready.png")
jythrow = love.graphics.newImage("me/attack/jythrow.png")
yready = love.graphics.newImage("me/attack/yready.png")
pyready = love.graphics.newImage("me/attack/pyready.png")
ythrow = love.graphics.newImage("me/attack/ythrow.png")
yblue = love.graphics.newImage("me/attack/yblue.png")
yblue2 = love.graphics.newImage("me/attack/yblue2.png")
yblue3 = love.graphics.newImage("me/attack/yblue3.png")
yblue4 = love.graphics.newImage("me/attack/yblue4.png")
yblue5 = love.graphics.newImage("me/attack/yblue5.png")
yblueend = love.graphics.newImage("me/attack/yblueend.png")
yblueend2 = love.graphics.newImage("me/attack/yblueend2.png")
jycready = love.graphics.newImage("me/attack/jycready.png")
jycthrow = love.graphics.newImage("me/attack/jycthrow.png")
ycready = love.graphics.newImage("me/attack/ycready.png")
ycthrow = love.graphics.newImage("me/attack/ycthrow.png")
pmine = love.graphics.newImage("me/attack/py.png")
mine = love.graphics.newImage("me/attack/y.png")
mine2 = love.graphics.newImage("me/attack/y2.png")
mine3 = love.graphics.newImage("me/attack/y3.png")
mine4 = love.graphics.newImage("me/attack/y4.png")
mine5 = love.graphics.newImage("me/attack/y5.png")
mine6 = love.graphics.newImage("me/attack/y6.png")
cmine2 = love.graphics.newImage("me/attack/yc1.png")
cmine3 = love.graphics.newImage("me/attack/yc2.png")
cmine4 = love.graphics.newImage("me/attack/yc3.png")
cmine5 = love.graphics.newImage("me/attack/yc4.png")
cmine6 = love.graphics.newImage("me/attack/yc5.png")

grenade = love.graphics.newImage("me/attack/grenade.png")
gyready = love.graphics.newImage("me/attack/gyready.png")
gythrow = love.graphics.newImage("me/attack/gythrow.png")
jgyready = love.graphics.newImage("me/attack/jgyready.png")
jgythrow = love.graphics.newImage("me/attack/jgythrow.png")
...
if youbyhold > 0 then 
	...
	youbyct = 0
	youbell = true
	if youarmsreach(55) and sameheight() and youbexpc < 100 and not you.dodge
	then youbexpc = 1
	youactionshot = true
	me.flinch = true
	me.ft = byft
...
if mebyhold > 0 then 
	...
	mebyct = 0
	mebell = true
	if mearmsreach(55) and sameheight() and mebexpc < 100 and not you.dodge
	then mebexpc = 1
	actionshot = true
	you.flinch = true
	you.ft = byft
...
elseif mepyct > 0 and not x then
	...
	me.stop = true
	me.jstop = true
	table.insert(mymines, {x = me.mid, y = me.y+30, s = -1,explode = 0})
	mepyct = 0
...
elseif youpyct > 0 and not x then
	...
	you.stop = true
	you.jstop = true
	table.insert(yourmines, {x = you.mid, y = you.y+30, s = -1,explode = 0})
	youpyct = 0
elseif x 
	then 
	youpyct = youpyct + 1
...
elseif youyct > ychargetime and not x then
	if you.g then
	you.im = ycthrow
	else you.im = jycthrow
	end
...
elseif youyct > ychargetime then
	if you.g then
	you.im = ycready
...
for i,v in ipairs(yourmines) do
	...
	if v.y + minedropgrav < spikecheck(v.x, v.y) then v.y = v.y + minedropgrav
		-- if + minegrav * 2 then sound of it landing
	else v.y = spikecheck(v.x,v.y)
	end
	end
	...
	if v.s == 100 then 
		...
		if v.y - v.j < spikecheck(v.x + v.v, v.y) 
			then v.y = v.y - v.j
			v.rotate = v.rotate + .1
		-- if + minegrav * 2 then sound of it landing
		else v.y = spikecheck(v.x + v.v,v.y)
			v.rotate = 0
			v.j = 0
			v.v = 0
		end
	...
	table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 0, s = 0, v = boltspeed * 1})
		table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -3, s = 0, v = boltspeed * 1})
		table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 6, s = 0, v = boltspeed * .96})
		table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -6, s = 0, v = boltspeed * .96})
		table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -12, s = 0, v = boltspeed * .93})
		table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 12, s = 0, v = boltspeed * .93})
		table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -18, s = 0, v = boltspeed * .9})
		table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 18, s = 0, v = boltspeed * .9})
		table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -24, s = 0, v = boltspeed * .9})
		table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 24, s = 0, v = boltspeed * .9})
		table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -30, s = 0, v = boltspeed * .9})
		table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 30, s = 0, v = boltspeed * .9})
		table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -36, s = 0, v = boltspeed * .9})
		table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 36, s = 0, v = boltspeed * .9})
		table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -42, s = 0, v = boltspeed * .9})
		table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 42, s = 0, v = boltspeed * .9})
		table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -48, s = 0, v = boltspeed * .9})
		table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 48, s = 0, v = boltspeed * .9})
		table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -54, s = 0, v = boltspeed * .9})
		table.insert(youbolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 54, s = 0, v = boltspeed * .9})
...
if v.s == -1 then
	if math.abs(me.mid-v.x) < 400 and me.feet >= v.y - 200 and me.y < v.y
		then
		table.remove(yourmines,i)
...
table.insert(youspikes, {x = v.x + (0 + math.random(8)) * 1, y = v.y - 10 + math.random(8), lr = 1, t = 0, s = 0, ss =1})
	...
	elseif v.s == 1 then 
		if v.explode == 2 then cyellowplay2() end
	...
	elseif v.s == 0 then 
		if v.explode == 2 then yellowplay2() end
...
elseif meyct > ychargetime and not x then
	if me.g then
	me.im = ycthrow
	else me.im = jycthrow
	end
...
if v.s == 1 or v.s == 0 or v.s == -1 then
	if v.y + minedropgrav < spikecheck(v.x, v.y) 
	...
	if v.s == 100 then 
		...
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 0, s = 0, v = boltspeed * 1})
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -3, s = 0, v = boltspeed * 1})
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 6, s = 0, v = boltspeed * .96})
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -6, s = 0, v = boltspeed * .96})
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -12, s = 0, v = boltspeed * .93})
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 12, s = 0, v = boltspeed * .93})
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -18, s = 0, v = boltspeed * .9})
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 18, s = 0, v = boltspeed * .9})
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -24, s = 0, v = boltspeed * .9})
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 24, s = 0, v = boltspeed * .9})
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -30, s = 0, v = boltspeed * .9})
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 30, s = 0, v = boltspeed * .9})
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -36, s = 0, v = boltspeed * .9})
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 36, s = 0, v = boltspeed * .9})
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -42, s = 0, v = boltspeed * .9})
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 42, s = 0, v = boltspeed * .9})
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -48, s = 0, v = boltspeed * .9})
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 48, s = 0, v = boltspeed * .9})
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = -54, s = 0, v = boltspeed * .9})
		table.insert(bolts, {x = v.x   * 1 , y = v.y - 20, lr = 1, time = 0, upv = 54, s = 0, v = boltspeed * .9})
...
if v.s == -1 then
	if math.abs(you.mid-v.x) < 400 and you.feet >= v.y - 200 and you.y < v.y
		then
		table.remove(mymines,i)
...
table.insert(spikes, {x = v.x + (0 + math.random(8)) * 1, y = v.y - 10 + math.random(8), lr = 1, t = 0, s = 0, ss =1})
	...
	elseif v.s == 1 then 
		if v.explode == 2 then cyellowplay() end
	...
	elseif v.s == 0 then 
		if v.explode == 2 then yellowplay() end
