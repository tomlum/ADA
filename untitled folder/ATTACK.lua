...
if you.flinch or mbgcancel then youbgready = false
	...
	if v.s == -200 or v.s == -201 then table.remove(youbolts, i)
	end
	end
	for i,v in ipairs(youbolts) do
	if v.s == -200 or v.s == -201 then table.remove(youbolts, i)
...
if me.flinch or mbgcancel then mebgready = false
	...
	if v.s == -200 or v.s == -201 then table.remove(bolts, i)
	end
	end
	for i,v in ipairs(bolts) do
	if v.s == -200 or v.s == -201 then table.remove(bolts, i)
...
dodgey = function ()
	...
	elseif dodgeycounter < 0
		...
		delayycounter = delaytime
		you.block = true
	elseif you.block and controller2.right and dodgeycounter == 0 and not you.slide and	not noyoudodge
		then
		you.dodge = true
		you.stop = false
	...
	elseif you.block and controller2.left and dodgeycounter == 0 and not you.slide and 	not noyoudodge
		then
		you.dodge = true
		you.stop = false
		dodgeycounter = - dodgetime
...
if you.flinch 
	...
	elseif dodgemecounter < 0
		...
		me.block = true
		delaymecounter = delaytime
	elseif me.block and controller1.right and dodgemecounter == 0 and not me.slide and not nomedodge
		then
		me.dodge = true
		me.stop = false
	...
	elseif me.block and controller1.left and dodgemecounter == 0 and not me.slide and not nomedodge
