...
--DRAW GLASS SHOULD MAKE THE GLASS GLIMMER LIKE RUBBLE CHANGING
--DRAW GLASS SHOULD MAKE THE GLASS GLIMMER LIKE RUBBLE CHANGING COLORS
--DRAW GLASS SHOULD MAKE THE GLASS GLIMMER LIKE RUBBLE CHANGING COLORS
--DRAW GLASS SHOULD MAKE THE GLASS GLIMMER LIKE RUBBLE CHANGING COLORS
--DRAW GLASS SHOULD MAKE THE GLASS GLIMMER LIKE RUBBLE CHANGING COLORS
--DRAW GLASS SHOULD MAKE THE GLASS GLIMMER LIKE RUBBLE CHANGING COLORS
...
function floorsveneer()
	if themap == "floors" then
if lvfade > 0  and ((me.mid > 418 and me.mid < 2140 and me.feet > 1898) or (you.mid > 418 and you.mid < 2140 and you.feet > 1898))
then lvfade = lvfade - 5
elseif lvfade < 255 then lvfade = lvfade + 5
end
love.graphics.setColor(255,255,255,lvfade)
...
love.graphics.draw(enviro.floorsveneer1, 3157, 2829)
love.graphics.setColor(255,255,255)
...
drawspine = function()
if table.getn(spines) < 1 and MENU ~= "postchoose"
then
...
if MENU == "postchoose" then soscillator = soscillator - 3
end
...
if soscillator == 0 and soup then n = 11
...
for i,v in ipairs(spines) do
	...
	love.graphics.draw(enviro.spine, 1440 - v.x, ((v.n * 40)/900)*screenheight-(50*screenheight/1000)+spineymove, 0, -screenwidth/1440, screenheight/1100)
...
armanimatey = function ()
	if you.slowdown and not you.dodge and not you.pause and not you.stop and not noyoudodge
	then 
