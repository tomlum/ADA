...
jumpd:setPitch(1.65 + (math.random() * .3) )
jumpd2:setPitch(1.65 + (math.random() * .3) )
...
flapsnd:setPitch(.8+ (math.random() * .3) )
flapsnd2:setPitch(.8 + (math.random() * .3) )
...
flapblues2 = love.audio.newSource("sounds/blue.mp3", "static")
flapblues2:setVolume(SFXV-adj-.6)
flapblues2:setPitch(1.3)

blueflap2 = love.audio.newSource("sounds/flap.wav", "stream")
blueflap2:setVolume(SFXV)
blueflap2:setPitch(1.3)

flapsnd = love.audio.newSource("sounds/flap.wav", "stream")
flapsnd:setVolume(SFXV - .4)

flapsnd2 = love.audio.newSource("sounds/flap.wav", "stream")
flapsnd2:setVolume(SFXV - .4)

blocksound2 = love.audio.newSource("sounds/block.wav", "stream")
blocksound2:setVolume(SFXV - .4)
...
jumpd = love.audio.newSource("sounds/dodgeslide.wav", "stream")
jumpd:setVolume(SFXV - .7)
jumpd2 = love.audio.newSource("sounds/dodgeslide.wav", "stream")
jumpd2:setVolume(SFXV - .7)
...
wallhit1:setVolume(SFXV-.4-adj)

wallhit2 = love.audio.newSource("sounds/Purple.wav", "static")
wallhit2:setVolume(SFXV-.4-adj)
