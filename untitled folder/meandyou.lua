...
controller2 = {}
	...
	enviro.ptile = love.graphics.newImage("enviro/nptile.png")
	enviro.ptile:setFilter("nearest")
	enviro.btile = love.graphics.newImage("enviro/nbtile.png")
	enviro.btile:setFilter("nearest")
	enviro.stile = love.graphics.newImage("enviro/nstile.png")
	enviro.stile:setFilter("nearest")
	enviro.gtile = love.graphics.newImage("enviro/ngtile.png")
	enviro.gtile:setFilter("nearest")
	enviro.ytile = love.graphics.newImage("enviro/nytile.png")
