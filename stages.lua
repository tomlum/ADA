...
table.insert(the_maps[1].walls, {n=11, y1 = -1, y2 = the_maps[1].floor, x=0, barrier = true})
table.insert(the_maps[1].walls, {n=12, y1 = -1, y2 = the_maps[1].floor, x=the_maps[1].rightwall, barrier = true})
...
table.insert(the_maps[3].plats, {n=4,y = 2756-286, x1 = 419, x2 = 809})
table.insert(the_maps[3].plats, {n=5,y = 2756-286, x1 = 1756, x2 = 2139})
table.insert(the_maps[3].plats, {n=6,y = 2756-286*2, x1 = 419, x2 = 645})
table.insert(the_maps[3].plats, {n=7,y = 2756-286*2, x1 = 2075, x2 = 2139})
table.insert(the_maps[3].plats, {n=8,y = 2756-286*3, x1 = 419, x2 = 636})
table.insert(the_maps[3].plats, {n=9,y = 2756-286*3, x1 = 2070, x2 = 2139})
table.insert(the_maps[3].plats, {n=10,y = 2756-286*4, x1 = 2072, x2 = 2139})
