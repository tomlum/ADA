...
function fractalrespawn(xx)
  ...
  while(firsttime) do
    firsttime = false
    local rannum = math.random(1, #the_map.plats)
    newplat = the_map.plats[rannum]
    xx.go_here = {}
...
function throwinto()
  the_map = fractals[math.random(1,5)]
  local map = the_map
  --[[
  the_map = fractals[math.random(1,3)]
  local map = the_map
  ...
  local start = the_map.start
  if onescreen then
    if start.x < 0 then

      me.x = the_map.width+start.x + (mexrig-me.x)
      you.x = the_map.width+start.x + (mexrig-you.x)
      local temp = me.x
      me.x = you.x
      you.x = temp
    else
    ...
    if start.x < 0 then
      me.x = the_map.width+start.x + (mexrig-me.x)
      you.x = the_map.width+start.x + (youxrig-you.x)
      local temp = me.x
      me.x = you.x
      you.x = temp
  ...
  if vertone then
    if start.y < 0 then
      me.y = the_map.height+start.y + (meyrig-me.y)
      you.y = the_map.height+start.y + (meyrig - you.y)
      local temp = me.y
      me.y = you.y
      you.y = temp
    ...
    if start.y < 0 then
      me.y = the_map.height+start.y + (meyrig-me.y)
      you.y = the_map.height+start.y + (youyrig - you.y)
      local temp = me.y
      me.y = you.y
      you.y = temp
