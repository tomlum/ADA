function death2(xx)
  if (game_mode == "duel" and xx.health < 0) or 
    (game_mode == "spectrum" and xx.lives <= 0) 
    or 
    (game_mode == "koth" and xx.score >= kothscoretowin)
    or 
...
if (game_mode == "koth" or game_mode == "fractal") and xx.health <= 0 then
...
if game_mode == "koth" and (xx.score >= kothscoretowin) and allfade < 1 then
  beginretry = true

elseif game_mode == "duel" or (game_mode == "spectrum" and xx.lives == 0) then
  if xx.health<0 then 
    xx.dead = true
...
elseif game_mode == "spectrum" then
  if xx.health<0 then 
