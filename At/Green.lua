...
for i, v in ipairs(youspikes) do
  ...
  if v.s >= 0 and distan(me.mid,me.y+30, point,ypoint) < whiffradius and distan(me.mid,me.y+30, point+v.v,ypoint-v.upv) > whiffradius and math.abs(v.v + v.upv) > 2 then
	...
	if youfired and youthrowanimatecounter < pauseforgreen
	...
	if youfired and youthrowanimatecounter < pauseforgreen or youboltchargecounter>=50 or you.im==boltrelease then yougree=true
		else yougree = false
	end
		
    if youthrowanimatecounter == 1 then 
  youwaittoaim = aimwait
...
if v.s >= 0 and distan(you.mid,you.y+30, point,ypoint) < whiffradius and distan(you.mid,you.y+30, point+v.v,ypoint-v.upv) > whiffradius and math.abs(v.v + v.upv) > 2 then
	...
	if mefired and methrowanimatecounter < pauseforgreen
	then 
...
if mefired and methrowanimatecounter < pauseforgreen or meboltchargecounter>=50 or me.im==boltrelease then megree=true
		else megree = false
	end

if methrowanimatecounter == 1 then 
  waittoaim = aimwait
