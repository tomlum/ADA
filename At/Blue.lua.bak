...
function blueblade(x, yy, mm, cy, cm)
  ...
  if not yy.g then
    ...
    then 
      ...
      if (yy.j >= 0 and not cy.down) or (cy.up and yy.j < 0) then
        hboxc({x = yy.mid, y= yy.y+30}, 
          ...
          {x = yy.mid+yy.v, y= yy.y+30}, true, yy.lr, true, true, yy.v + (5*yy.lr), yy.j+6, airbluedam, true, abft*3, 0, 0, "air", yy.id)
      ...
      elseif (yy.j < 0 and not cy.up) or (cy.down and yy.j >= 0) then
        ...
        hboxc({x = yy.mid, y= yy.y+30}, 
          {x = yy.mid, y= yy.y+200-yy.j},
          {x = yy.mid+200*yy.lr+yy.v, y= yy.y+200-yy.j},
          {x = yy.mid+yy.v, y= yy.y+30}, true, yy.lr, true, true, yy.v + (10*yy.lr), yy.j-20, airbluedam, true, abft/3, 0, 0, 0, yy.id)
    ...
    if yy.bnext==20 then yy.im = bc2 
      yy.d = 24
      hc(yy.mid, yy.y+30, yy.mid+yy.v+170*yy.lr, yy.y+30-yy.j, false, yy.lr, false, true, yy.v + (80*yy.lr), yy.j, bluechargedam, bcft, 0, 0, 0, yy.id)
    ...
    then yy.im = blue33
      yy.d = 12
      yy.bluechargetimer = 0
      hc(yy.mid, yy.y+30, yy.mid+yy.v+250*yy.lr, yy.y+30-yy.j, false, yy.lr, true, true, yy.v + (20*yy.lr), yy.j, bluedam, bft/2, 0, 0,0, yy.id)
    ...
    then yy.im = blue22
      ...
      hc(yy.mid, yy.y+30, yy.mid+yy.v+160*yy.lr, yy.y+30-yy.j, true, yy.lr, true, true, yy.v + (4*yy.lr), yy.j, bluedam, bft/3, 0, 0, 0, yy.id)
    ...
    then
      ...
      hc(yy.mid, yy.y+30, yy.mid+yy.v+160*yy.lr, yy.y+30-yy.j, true, yy.lr, false, true, yy.v + (4*yy.lr), yy.j, bluedam, bft/2, 0, 0, 0, yy.id)
