...
elseif me.flip < 0 then
  ...
  if me.a4 then ma4fade = 255 else ma4fade = basefade end
...
elseif you.flip < 0 then 
  ...
  if you.a4 then ya4fade = 255 else ya4fade = basefade end
...
love.graphics.draw(enviro.rubble,v.x,v.y-2,70/(v.v+v.y),math.random(),1,1)
love.graphics.setColor(255,255,255)
