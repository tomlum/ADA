...
for i, v in ipairs(youspikes) do
	...
	elseif v.s == -1 and spoint * v.lr < (me.mid) * v.lr and (spoint + v.v-1) * v.lr > (me.mid + me.v) * v.lr
	...
	elseif v.s == -201 and spoint * v.lr < (me.mid) * v.lr and (spoint + v.v-1) * v.lr > (me.mid + me.v) * v.lr
	and not me.dodge
	and v.y - v.upv + 7 > me.y and v.y - v.upv + 7 < me.feet
			then table.remove(youbolts, i)
			ybgcatch = true
			me.v = -thev(math.abs(you.x - me.x)) * you.lr
			if not me.block or v.lr == you.lr then
	...
	elseif v.s >= 0 and point * v.lr < (me.mid) * v.lr and (point + v.v-1) * v.lr > (me.mid + me.v) * v.lr
	and v.y - v.upv + 7 > me.y and v.y - v.upv + 7 < me.feet
			then table.remove(youbolts, i)
			me.v = me.v + v.lr * 4
				if not me.block
...
function bolts.update()
	...
	elseif v.s == -201 and spoint * v.lr < (you.mid) * v.lr and (spoint + v.v-1) * v.lr > (you.mid + you.v) * v.lr
	and not you.dodge
	and v.y - v.upv + 7 > you.y and v.y - v.upv + 7 < you.feet
			then table.remove(bolts, i)
			bgcatch = true
			you.v = -thev(math.abs(you.x - me.x)) * me.lr
			if not you.block or v.lr == you.lr then
	...
	elseif v.s == -1 and spoint * v.lr < (you.mid) * v.lr and (spoint + v.v-1) * v.lr > (you.mid + you.v) * v.lr
	and not you.dodge
	and v.y - v.upv + 7 > you.y and v.y - v.upv + 7 < you.feet
			then table.remove(bolts, i)
			you.v = you.v + v.lr * 4
	...
	elseif v.s >= 0 and point * v.lr < (you.mid) * v.lr and (point + v.v-1) * v.lr > (you.mid + you.v) * v.lr
	and v.y - v.upv + 7 > you.y and v.y - v.upv + 7 < you.feet
			then table.remove(bolts, i)
			you.v = you.v + v.lr * 4
				if not you.block
