...
elseif not x and youbpready then
	...
	youbpcd = 110
	youbur = true
	table.insert(youspikes, {x = you.mid + 30*you.lr, y = spikecheck(you.mid + 30*you.lr, you.y - 160) - 140, lr = you.lr, t = 55, s = -200})
...
elseif not x and mebpready then
	...
	me.jstop = true
	mebpcd = 110
	table.insert(spikes, {x = me.mid + 30*me.lr, y = spikecheck(me.mid + 30*me.lr, me.y - 160) - 140, lr = me.lr, t = 55, s = -200})
	mebur = true
