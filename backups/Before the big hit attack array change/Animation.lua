...
if findxIntersect(600,4419,633,4455,me.mid+me.v,me.y-me.j+30,me.mid,me.y+30,true,true) and mespeed > paperweight then
    makepapers(me.mid,me.y,me.v, me.j, 8)
end

if findxIntersect(1528,3574,1542,3587,me.mid+me.v,me.y-me.j+30,me.mid,me.y+30,true,true) and mespeed > paperweight then
    makepapers(me.mid,me.y,me.v, me.j, 2)
end

if findxIntersect(1882,4366,1965,4472,me.mid+me.v,me.y-me.j+30,me.mid,me.y+30,true,true) and mespeed > paperweight then
    makepapers(me.mid,me.y,me.v, me.j, 40)
end

if findxIntersect(1803,5002,1832,5019,me.mid+me.v,me.y-me.j+30,me.mid,me.y+30,true,true) and mespeed > paperweight then
    makepapers(me.mid,me.y,me.v, me.j, 5)
end

if findxIntersect(718,4994,751,5018,me.mid+me.v,me.y-me.j+30,me.mid,me.y+30,true,true) and mespeed > paperweight then
    makepapers(me.mid,me.y,me.v, me.j, 6)
end


if findxIntersect(838,5278,856,5304,me.mid+me.v,me.y-me.j+30,me.mid,me.y+30,true,true) and mespeed > paperweight then
    makepapers(me.mid,me.y,me.v, me.j, 5)
end

if findxIntersect(1524,5282,1538,5304,me.mid+me.v,me.y-me.j+30,me.mid,me.y+30,true,true) and mespeed > paperweight then
    makepapers(me.mid,me.y,me.v, me.j, 4)
end

if findxIntersect(1712,5269,1725,5278,me.mid+me.v,me.y-me.j+30,me.mid,me.y+30,true,true) and mespeed > paperweight then
    makepapers(me.mid,me.y,me.v, me.j, 1)
end

if findxIntersect(1558,5573,1581,5590,me.mid+me.v,me.y-me.j+30,me.mid,me.y+30,true,true) and mespeed > paperweight then
    makepapers(me.mid,me.y,me.v, me.j, 1)
end


if findxIntersect(600,4419,633,4455,you.mid+you.v,you.y-you.j+30,you.mid,you.y+30,true,true) and youspeed > paperweight then
    makepapers(you.mid,you.y,you.v,you.j, 8)
end
if findxIntersect(1528,3574,1542,3587,you.mid+you.v,you.y-you.j+30,you.mid,you.y+30,true,true) and youspeed > paperweight then
    makepapers(you.mid,you.y,you.v,you.j, 2)
end
if findxIntersect(1882,4366,1965,4472,you.mid+you.v,you.y-you.j+30,you.mid,you.y+30,true,true) and youspeed > paperweight then
    makepapers(you.mid,you.y,you.v,you.j, 40)
end
if findxIntersect(1803,5002,1832,5019,you.mid+you.v,you.y-you.j+30,you.mid,you.y+30,true,true) and youspeed > paperweight then
    makepapers(you.mid,you.y,you.v,you.j, 5)
end
if findxIntersect(718,4994,751,5018,you.mid+you.v,you.y-you.j+30,you.mid,you.y+30,true,true) and youspeed > paperweight then
    makepapers(you.mid,you.y,you.v,you.j, 6)
end

if findxIntersect(838,5278,856,5304,you.mid+you.v,you.y-you.j+30,you.mid,you.y+30,true,true) and youspeed > paperweight then
    makepapers(you.mid,you.y,you.v,you.j, 5)
end
if findxIntersect(1524,5282,1538,5304,you.mid+you.v,you.y-you.j+30,you.mid,you.y+30,true,true) and youspeed > paperweight then
    makepapers(you.mid,you.y,you.v,you.j, 4)
end
if findxIntersect(1712,5269,1725,5278,you.mid+you.v,you.y-you.j+30,you.mid,you.y+30,true,true) and youspeed > paperweight then
    makepapers(you.mid,you.y,you.v,you.j, 1)
end
if findxIntersect(1558,5573,1581,5590,you.mid+you.v,you.y-you.j+30,you.mid,you.y+30,true,true) and youspeed > paperweight then
    makepapers(you.mid,you.y,you.v,you.j, 1)
end
...
if findxIntersect(600,4419,633,4455,q.x+q.v,q.y,q.x,q.y,true,true) then
    makepapers(q.x,q.y,q.v,windpush,1)
end
if findxIntersect(1528,3574,1542,3587,q.x+q.v,q.y,q.x,q.y,true,true) then
    makepapers(q.x,q.y,q.v,windpush,1)
end
if findxIntersect(1882,4366,1965,4472,q.x+q.v,q.y,q.x,q.y,true,true) then
    makepapers(q.x,q.y,q.v,windpush,1)
end
if findxIntersect(1803,5002,1832,5019,q.x+q.v,q.y,q.x,q.y,true,true) then
    makepapers(q.x,q.y,q.v,windpush,1)
end
if findxIntersect(718,4994,751,5018,q.x+q.v,q.y,q.x,q.y,true,true) then
    makepapers(q.x,q.y,q.v,windpush,1)
end
if findxIntersect(838,5278,856,5304,q.x+q.v,q.y,q.x,q.y,true,true) then
    makepapers(q.x,q.y,q.v,windpush,1)
end
if findxIntersect(1524,5282,1538,5304,q.x+q.v,q.y,q.x,q.y,true,true) then
    makepapers(q.x,q.y,q.v,windpush,1)
end
if findxIntersect(1712,5269,1725,5278,q.x+q.v,q.y,q.x,q.y,true,true) then
    makepapers(q.x,q.y,q.v,windpush,1)
end
if findxIntersect(1558,5573,1581,5590,q.x+q.v,q.y,q.x,q.y,true,true) then
    makepapers(q.x,q.y,q.v,windpush,1)
end
end
...
for i,v in ipairs(spines) do
	...
	if oddeven%4 == 1 then
		if v.n >= 1 then 
			v.v = spines[i+1].v
			v.x = v.x + v.v 
			if math.abs(v.v) >= (15.5*screenwidth)/1440 and not seperateSpines then 
				if v.v > 0 then 
			...
			if math.abs(v.v) >= (15.5*screenwidth)/1440 and not seperateSpine then 
				if v.v > 0 then 
