...
attackme = function ()
	...
	if controller1.block and delaymecounter == 0 and not controller1.a1 and not controller1.a2 and not controller1.a3 and me.g
	then me.im = block
		me.block = true
		me.stop = true
	...
	if controller2.block and delayycounter == 0 and not controller2.a1 and not controller2.a2 and not controller2.a3 and you.g
	then you.im = block
		you.block = true
		you.stop = true
