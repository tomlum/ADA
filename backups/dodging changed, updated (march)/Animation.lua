...
righty = controller2.left
lefty = controller2.right
rightme = controller1.right
leftme = controller1.left
...
orient = function ()
	if not you.slowdown and not you.slide or you.dodge
		then
	rightyy = controller2.right
	leftyy = controller2.left
end

	if rightyy and not leftyy and not you.slowdown then righty = true
				lefty = false
		elseif leftyy and not rightyy and not you.slowdown then lefty = true
				righty = false
			else righty = righty 
				 lefty = lefty
	end
	...
	if not me.slowdown and not me.slide or me.dodge
		then
